		...
		<div class="row">
			...
			<div class="col-md-2">
				<div class="list-group">
					...
					<a href="aboutMe.jsp" class="list-group-item  active">关于我们</a>
			...
			<div class="col-md-10">
				...
				<!--上传帮帮帮内容s-->
				<form action="#" class="user_search" style="height: 650px;">

					<div class="form-group">
						<label for="content">描述内容</label>
						<textarea class="form-control" rows="7" cols="10" placeholder="请输介绍" id="content"></textarea>
					</div>
					<div class="form-group">
						<label for="content">描述内容</label>
						<textarea class="form-control" rows="7" cols="10" placeholder="请输入历史" id="content"></textarea>
					</div>	
					<div class="form-group">
