	...
	var a = 0;
		...
		$(function () {
            ...
            var successCallBack1 = function (result1) {
                ...
                $("#result1").val("上传成功");
                $('#uploadFile_img1').attr("src", "http://kcat-1251241286.cosgz.myqcloud.com/images/"+time_name1);
                ico_flag = true;
            };
            ...
            var successCallBack2 = function (result2) {
                ...
                $("#result2").val("上传成功");
                $('#uploadFile_img2').attr("src", "http://kcat-1251241286.cosgz.myqcloud.com/images/"+time_name1);
                jpg_flag = true;
            };
            ...
            $('#uploadFile1').on('click', function () {
                ...
                $('#js-file1').off('change').on('change', function (e) {
                    ...
                    time_name1 += img_name_last;
                    $('#result1').val(time_name1);
                    error_cancel("result1");
                	cos.uploadFile(successCallBack1, errorCallBack1, progressCallBack1, bucket, myFolder + time_name1, file, 0, taskReady);//insertOnly==0 表示允许覆盖文件 1表示不允许
                	$('#form1')[0].reset();
                	return false;
                });
